...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__CampaignM__copyl__3E52440B] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[CampaignMember] ADD CONSTRAINT [PK__Campaign__3214EC0776BBD5F4] PRIMARY KEY CLUSTERED  ([Id])
GO
