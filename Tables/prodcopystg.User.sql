...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__User__copyloadda__5DCAEF64] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[User] ADD CONSTRAINT [PK__User__3214EC07BB9624C3] PRIMARY KEY CLUSTERED  ([Id])
GO
