CREATE TABLE [prodcopy].[TM_Transaction__c]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__TM_Transa__copyl__09A971A2] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[TM_Transaction__c] ADD CONSTRAINT [PK__TM_Trans__3214EC073DAFF499] PRIMARY KEY CLUSTERED  ([Id])
GO
