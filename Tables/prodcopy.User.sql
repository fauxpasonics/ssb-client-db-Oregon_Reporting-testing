...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__User__copyloadda__5AEE82B9] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[User] ADD CONSTRAINT [PK__User__3214EC07834A58B5] PRIMARY KEY CLUSTERED  ([Id])
GO
