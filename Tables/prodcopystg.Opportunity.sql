...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Opportuni__copyl__46E78A0C] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Opportunity] ADD CONSTRAINT [PK__Opportun__3214EC07CEAF0613] PRIMARY KEY CLUSTERED  ([Id])
GO
