...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__UserRole__copylo__6383C8BA] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[UserRole] ADD CONSTRAINT [PK__UserRole__3214EC0774C72579] PRIMARY KEY CLUSTERED  ([Id])
GO
