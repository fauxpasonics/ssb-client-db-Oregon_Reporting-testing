...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Campaign__copylo__3B75D760] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Campaign] ADD CONSTRAINT [PK__Campaign__3214EC07300C41CE] PRIMARY KEY CLUSTERED  ([Id])
GO
