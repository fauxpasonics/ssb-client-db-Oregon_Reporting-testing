...
[OtherAddress] [ntext] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[MailingAddress] [ntext] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[DoNotCall] [bit] NULL,
[Oregon_Alum_Spouse__c] [bit] NULL,
[Oregon_Alum__c] [bit] NULL,
[Oregon_Grad_Year_Spouse__c] [nvarchar] (4) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Oregon_Grad_Year__c] [nvarchar] (4) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Oregon_Student_Athlete__c] [ntext] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Oregon_Student_Athlete_Spouse__c] [ntext] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__25869641] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Contact] ADD CONSTRAINT [PK__Contact__3214EC07263A0483] PRIMARY KEY CLUSTERED  ([Id])
GO
