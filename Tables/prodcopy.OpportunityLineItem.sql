...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Opportuni__copyl__4CA06362] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[OpportunityLineItem] ADD CONSTRAINT [PK__Opportun__3214EC076B22AD86] PRIMARY KEY CLUSTERED  ([Id])
GO
