...
[Item_Title__c] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Season_Name__c] [nvarchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Transacti__copyl__5812160E] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Transaction__c] ADD CONSTRAINT [PK__Transact__3214EC07E255EAD6] PRIMARY KEY CLUSTERED  ([Id])
GO
