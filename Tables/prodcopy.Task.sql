...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Task__copyloadda__4F7CD00D] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Task] ADD CONSTRAINT [PK__Task__3214EC07A99ECAE3] PRIMARY KEY CLUSTERED  ([Id])
GO
