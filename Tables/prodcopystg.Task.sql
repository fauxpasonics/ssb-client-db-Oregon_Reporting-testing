...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Task__copyloadda__52593CB8] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Task] ADD CONSTRAINT [PK__Task__3214EC07D9C4D018] PRIMARY KEY CLUSTERED  ([Id])
GO
