...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Marketing__copyl__6EF57B66] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Marketing_Activity__c] ADD CONSTRAINT [PK__Marketin__3214EC076C1C1966] PRIMARY KEY CLUSTERED  ([Id])
GO
