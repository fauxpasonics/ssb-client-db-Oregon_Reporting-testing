...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__RecordTyp__copyl__2F10007B] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[RecordType] ADD CONSTRAINT [PK__RecordTy__3214EC07CDDA3257] PRIMARY KEY CLUSTERED  ([Id])
GO
