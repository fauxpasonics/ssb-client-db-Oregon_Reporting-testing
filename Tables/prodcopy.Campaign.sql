...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Campaign__copylo__38996AB5] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Campaign] ADD CONSTRAINT [PK__Campaign__3214EC078FBC48AD] PRIMARY KEY CLUSTERED  ([Id])
GO
