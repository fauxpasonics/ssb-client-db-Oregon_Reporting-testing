...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Opportuni__copyl__49C3F6B7] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[OpportunityLineItem] ADD CONSTRAINT [PK__Opportun__3214EC07A25F837E] PRIMARY KEY CLUSTERED  ([Id])
GO
