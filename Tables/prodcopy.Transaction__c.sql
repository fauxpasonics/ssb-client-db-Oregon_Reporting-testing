...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Transacti__copyl__5535A963] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Transaction__c] ADD CONSTRAINT [PK__Transact__3214EC0777ED5DF4] PRIMARY KEY CLUSTERED  ([Id])
GO
